...
export default function Catalog({ airConditioners }: { airConditioners: AirConditioner[] }) {
    ...
    // Если «накопительный» режим включен, показываем все товары до currentPage,
    // иначе – только товары для выбранной страницы
    ...
    // Простейшая мапа для вывода категорий
    ...
    return (
        <div className="container mx-auto px-4 w-full">
            {/* Шапка каталога (сортировка + счетчик) */}
            ...
            {/* Если товаров ещё нет (или идёт загрузка), показываем скелетон */}
...
// Пример простого скелетона (9 «заглушек»)
